  ...
  return (
    <Layout>
      <div className='relative flex flex-col items-center justify-center min-h-[600px] text-center bg-linear-to-br from-primary via-primary-dark to-primary-light text-white rounded-2xl p-8 overflow-hidden'>
        ...
        <form onSubmit={handleSearch} className='relative z-10 w-full max-w-5xl backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-6 shadow-2xl'>
            ...
            <div className='flex flex-col'>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  min={today}
                  required
                  className='w-full pl-10 pr-3 py-2.5 rounded-lg bg-white/20 backdrop-blur-sm border border-white/30 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-secondary transition-all [color-scheme:dark]'
                />
              </div>
            </div>
          </div>
