...
export default function NewMaintenancePage({ basePath, HeaderComponent }: SharedPageProps) {
  ...
  useEffect(() => {
    ...
    // Check for preselected vehicle from localStorage
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setToast({
          show: true,
          message: data.error || 'Failed to schedule maintenance',
          type: 'error'
        })
      }
    } catch (error) {
  ...
  return (
    <>
      <HeaderComponent title="Schedule Maintenance" subtitle="Schedule maintenance for a vehicle" />
                    ...
                    >
                      ...
                      {vehicles.map((vehicle) => (
                        <option key={vehicle.id} value={vehicle.id}>
                          {vehicle.name} - {vehicle.plateNumber} ({vehicle.mileage.toLocaleString()} km)
                        </option>
                      ))}
                    </select>
                  </div>
                  ...
                  <div className='space-y-4'>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder='Describe the maintenance service...'
                      />
                    </div>
                  ...
                  <div className='space-y-4'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className='w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-primary focus:outline-none transition-colors text-[#000000]'
                        />
                        <p className='text-xs text-gray-500 mt-1'>Only if already completed</p>
                      </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          min='0'
                          className='w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-primary focus:outline-none transition-colors text-[#000000] placeholder:text-gray-400'
                          placeholder={selectedVehicle ? selectedVehicle.mileage.toString() : '0'}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className='w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-primary focus:outline-none transition-colors text-[#000000]'
                      />
                      <p className='text-xs text-gray-500 mt-1'>For recurring maintenance</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className='border-t border-gray-200 pt-4'>
                      ...
                      {formData.serviceProvider && (
                        <div className='flex justify-between text-sm mb-2'>
                          ...
                          <span className='text-[#000000] text-right text-xs'>{formData.serviceProvider}</span>
                        </div>
                      )}
                    </div>
                  </div>
