...
export default function EditVehiclePage({ basePath, HeaderComponent }: SharedPageProps) {
  ...
  if (fetching) {
    return (
      <>
        <HeaderComponent title="Edit Vehicle" subtitle="Loading..." />
  ...
  return (
    <>
      <HeaderComponent title="Edit Vehicle" subtitle="Update vehicle information" />
                    ...
                    <div className='border-t border-gray-200 pt-4'>
                      ...
                      <div className='flex justify-between text-sm'>
                        ...
                        <span className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full border ${
                          formData.status === 'available' ? 'bg-green-100 text-green-800 border-green-200' :
                          formData.status === 'rented' ? 'bg-blue-100 text-blue-800 border-blue-200' :
